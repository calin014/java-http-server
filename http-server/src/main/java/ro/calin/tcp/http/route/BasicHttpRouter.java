...
public class BasicHttpRouter implements HttpRouter {
    ...
    @Override
    public void addRoute(HttpMethod method, String urlPattern, HttpServler servler) {
        synchronized (routes) {
    ...
    @Override
    public HttpServler findRoute(HttpMethod method, String url) {
        synchronized (routes) {
    ...
    private static class Route {
        ...
        private Route(HttpMethod method, String urlPattern, HttpServler servler) {
            this.method = method;
